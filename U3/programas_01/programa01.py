...
• Funcionalidad: Imprime por pantalla un mensaje saludando a la persona en función de los parámetros de entrada.
"""


def saludar(nombre, ape1, ape2):
    print(f"¡Hola! {nombre} {ape1} {ape2}")


saludar("Elia", "Gil", "Martínez")
